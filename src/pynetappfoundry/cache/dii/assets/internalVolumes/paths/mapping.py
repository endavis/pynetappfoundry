"""DiiAssetsInternalvolumesPath type mapping."""
...
DIIASSETSINTERNALVOLUMESPATH_MAPPING = TypeMapping(
    name="DiiAssetsInternalvolumesPath",
    model_class=DiiAssetsInternalvolumesPath,
    api_endpoint="/assets/internalVolumes/{id}/paths",
    api_type="dii",
    records_path="",
    fields=(
        FieldMapping(
...
model_registry.register_mapping(
    "DiiAssetsInternalvolumesPath", DIIASSETSINTERNALVOLUMESPATH_MAPPING
)
