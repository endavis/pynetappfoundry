"""DiiAssetsInternalvolumesStoragenode type mapping."""
...
DIIASSETSINTERNALVOLUMESSTORAGENODE_MAPPING = TypeMapping(
    name="DiiAssetsInternalvolumesStoragenode",
    model_class=DiiAssetsInternalvolumesStoragenode,
    api_endpoint="/assets/internalVolumes/{id}/storageNodes",
    api_type="dii",
    records_path="",
    fields=(
        FieldMapping(
...
model_registry.register_mapping(
    "DiiAssetsInternalvolumesStoragenode", DIIASSETSINTERNALVOLUMESSTORAGENODE_MAPPING
)
