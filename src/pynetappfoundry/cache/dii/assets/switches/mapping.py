"""DiiAssetsSwitche type mapping."""

from __future__ import annotations

from pynetappfoundry.cache._registry import model_registry
from pynetappfoundry.cache.field_mapping import FieldMapping, TypeMapping
from pynetappfoundry.models.dii.assets.switches.model import DiiAssetsSwitche

DIIASSETSSWITCHE_MAPPING = TypeMapping(
    name="DiiAssetsSwitche",
    model_class=DiiAssetsSwitche,
    api_endpoint="/assets/switches",
    api_type="dii",
    identifier_field="id",
    records_path="",
    fields=(
...
model_registry.register_mapping("DiiAssetsSwitche", DIIASSETSSWITCHE_MAPPING)
