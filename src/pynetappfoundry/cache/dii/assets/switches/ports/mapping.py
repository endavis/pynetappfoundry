"""DiiAssetsSwitchesPort type mapping."""
...
DIIASSETSSWITCHESPORT_MAPPING = TypeMapping(
    name="DiiAssetsSwitchesPort",
    model_class=DiiAssetsSwitchesPort,
    api_endpoint="/assets/switches/{id}/ports",
    api_type="dii",
    records_path="",
...
model_registry.register_mapping("DiiAssetsSwitchesPort", DIIASSETSSWITCHESPORT_MAPPING)
