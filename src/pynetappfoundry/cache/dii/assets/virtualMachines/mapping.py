"""DiiAssetsVirtualmachine type mapping."""
...
DIIASSETSVIRTUALMACHINE_MAPPING = TypeMapping(
    name="DiiAssetsVirtualmachine",
    model_class=DiiAssetsVirtualmachine,
    api_endpoint="/assets/virtualMachines",
    api_type="dii",
    identifier_field="id",
    records_path="",
    fields=(
...
model_registry.register_mapping("DiiAssetsVirtualmachine", DIIASSETSVIRTUALMACHINE_MAPPING)
