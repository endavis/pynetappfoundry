...
class OntapAggregateSimulatedRaidGroup(CacheModel):
...
class OntapAggregateStoragePool(CacheModel):
...
class OntapAggregatePlex(CacheModel):
    """OntapAggregatePlex sub-model for plexes."""

    block_storage_plexes_name: str = ""


class OntapAggregateSimulatedRaidGroup2(CacheModel):
...
class OntapAggregateStore(CacheModel):
...
class OntapAggregate(CacheModel):
    """OntapAggregate information."""
