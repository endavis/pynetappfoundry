"""OntapVolumeMetricsResponse type mapping."""

from __future__ import annotations

from pynetappfoundry.cache._registry import model_registry
from pynetappfoundry.cache.field_mapping import FieldMapping, TypeMapping
from pynetappfoundry.cache.storage.volumes.metrics.model import OntapVolumeMetricsResponse

ONTAPVOLUMEMETRICSRESPONSE_MAPPING = TypeMapping(
    name="OntapVolumeMetricsResponse",
    model_class=OntapVolumeMetricsResponse,
    api_endpoint="/storage/volumes/{volume.uuid}/metrics?fields=*",
    api_type="ontap",
...
model_registry.register_mapping("OntapVolumeMetricsResponse", ONTAPVOLUMEMETRICSRESPONSE_MAPPING)
