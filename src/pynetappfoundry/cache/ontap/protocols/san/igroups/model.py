...
class OntapIgroupAlert(CacheModel):
...
class OntapIgroupRequiredNode(CacheModel):
...
class OntapIgroupIgroup(CacheModel):
...
class OntapIgroupInitiator(CacheModel):
...
class OntapIgroupLunMap(CacheModel):
...
class OntapIgroupParentIgroup(CacheModel):
...
class OntapIgroupArgument(CacheModel):
