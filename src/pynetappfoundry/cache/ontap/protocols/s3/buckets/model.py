...
class OntapS3BucketAggregate(CacheModel):
...
class OntapS3BucketRule(CacheModel):
...
class OntapS3BucketRule2(CacheModel):
...
class OntapS3BucketStatement(CacheModel):
...
class OntapS3Bucket(CacheModel):
    """OntapS3Bucket information."""
    ...
    cors_rules: list[OntapS3BucketRule] = Field(default_factory=list)
    encryption_enabled: bool = False
    lifecycle_management_rules: list[OntapS3BucketRule2] = Field(default_factory=list)
    logical_used_size: int = 0
    name: str = ""
    nas_path: str = ""
    policy_statements: list[OntapS3BucketStatement] = Field(default_factory=list)
