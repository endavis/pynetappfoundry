...
class OntapConsistencyGroupResponseConsistencyGroup(CacheModel):
...
class OntapConsistencyGroupResponseLun(CacheModel):
...
class OntapConsistencyGroupResponseNamespace(CacheModel):
...
class OntapConsistencyGroupResponseReplicationRelationship(CacheModel):
...
class OntapConsistencyGroupResponseObjectStore(CacheModel):
    """OntapConsistencyGroupResponseObjectStore sub-model for object_stores."""

    tiering_object_stores_name: str = ""


class OntapConsistencyGroupResponseVolume(CacheModel):
...
class OntapConsistencyGroupResponse(CacheModel):
    """OntapConsistencyGroupResponse information."""
