...
class OntapApplicationComponentLun(CacheModel):
...
class OntapApplicationComponentNamespace(CacheModel):
...
class OntapApplicationComponentVolume(CacheModel):
...
class OntapApplicationComponentCifsAccess(CacheModel):
...
class OntapApplicationComponentNfsAccess(CacheModel):
...
class OntapApplicationComponentNvmeAccess(CacheModel):
...
class OntapApplicationComponentProtectionGroup(CacheModel):
...
class OntapApplicationComponentSanAccess(CacheModel):
