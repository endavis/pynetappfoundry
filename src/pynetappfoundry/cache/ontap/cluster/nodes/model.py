...
class OntapNodeResponseClusterInterface(CacheModel):
...
class OntapNodeResponseFlashCache(CacheModel):
...
class OntapNodeResponseFru(CacheModel):
...
class OntapNodeResponseStatus(CacheModel):
...
class OntapNodeResponsePartner(CacheModel):
...
class OntapNodeResponsePort(CacheModel):
...
class OntapNodeResponseManagementInterface(CacheModel):
...
class OntapNodeResponsePort2(CacheModel):
    """OntapNodeResponsePort2 sub-model for ports."""

    metrocluster_ports_name: str = ""


class OntapNodeResponse(CacheModel):
    """OntapNodeResponse information."""
