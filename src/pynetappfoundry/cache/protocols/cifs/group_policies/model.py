...
class OntapPoliciesAndRulesToBeAppliedAccessPolicy(CacheModel):
...
class OntapPoliciesAndRulesToBeAppliedAccessRule(CacheModel):
...
class OntapPoliciesAndRulesToBeAppliedObject(CacheModel):
...
class OntapPoliciesAndRulesToBeAppliedRestrictedGroup(CacheModel):
...
class OntapPoliciesAndRulesToBeApplied(CacheModel):
    """OntapPoliciesAndRulesToBeApplied information."""
