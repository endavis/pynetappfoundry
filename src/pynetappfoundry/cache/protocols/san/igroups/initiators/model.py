...
class OntapIgroupInitiatorAlert(CacheModel):
...
class OntapIgroupInitiatorConnection(CacheModel):
...
class OntapIgroupInitiatorPeerSvm(CacheModel):
...
class OntapIgroupInitiatorRecord(CacheModel):
