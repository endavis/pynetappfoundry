...
class OntapApplicationTemplateNewIgroup(CacheModel):
...
class OntapApplicationTemplateSecondaryIgroup(CacheModel):
    """OntapApplicationTemplateSecondaryIgroup sub-model for secondary_igroups."""

    mongo_db_on_san_secondary_igroups_name: str = ""


class OntapApplicationTemplateApplicationComponent(CacheModel):
...
class OntapApplicationTemplateCifsAccess(CacheModel):
...
class OntapApplicationTemplateExcludeAggregate(CacheModel):
...
class OntapApplicationTemplateNfsAccess(CacheModel):
...
class OntapApplicationTemplateComponent(CacheModel):
...
class OntapApplicationTemplateNfsAccess2(CacheModel):
...
class OntapApplicationTemplateNewIgroup2(CacheModel):
...
class OntapApplicationTemplateNfsAccess3(CacheModel):
...
class OntapApplicationTemplateDbSid(CacheModel):
    """OntapApplicationTemplateDbSid sub-model for db_sids."""

    oracle_rac_on_san_db_sids_igroup_name: str = ""


class OntapApplicationTemplateNewIgroup3(CacheModel):
...
class OntapApplicationTemplateApplicationComponent2(CacheModel):
...
class OntapApplicationTemplateApplicationComponent3(CacheModel):
...
class OntapApplicationTemplateExcludeAggregate2(CacheModel):
...
class OntapApplicationTemplateNewIgroup4(CacheModel):
...
class OntapApplicationTemplateNewIgroup5(CacheModel):
...
class OntapApplicationTemplateNfsAccess4(CacheModel):
...
class OntapApplicationTemplateNewIgroup6(CacheModel):
...
class OntapApplicationTemplateNfsAccess5(CacheModel):
...
class OntapApplicationTemplateNewIgroup7(CacheModel):
...
class OntapApplicationTemplate(CacheModel):
    """OntapApplicationTemplate information."""
