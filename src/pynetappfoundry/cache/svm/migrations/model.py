...
class OntapSvmMigrationAggregate(CacheModel):
...
class OntapSvmMigrationVolumeAggregatePair(CacheModel):
...
class OntapSvmMigrationIpInterface(CacheModel):
...
class OntapSvmMigrationMessage(CacheModel):
...
class OntapSvmMigration(CacheModel):
    """OntapSvmMigration information."""
