# ruff: noqa: N815
"""DiiAssetsVolumesReplicasource information."""
...
class DiiAssetsVolumesReplicasourceCapacity(OntapModel):
    """DiiAssetsVolumesReplicasourceCapacity sub-model for capacity."""
...
class DiiAssetsVolumesReplicasourcePerformance(OntapModel):
    """DiiAssetsVolumesReplicasourcePerformance sub-model for performance."""
...
class DiiAssetsVolumesReplicasource(OntapModel):
    """DiiAssetsVolumesReplicasource information."""
    ...
    uuid: str = ""
    capacity: DiiAssetsVolumesReplicasourceCapacity = Field(
        default_factory=DiiAssetsVolumesReplicasourceCapacity
    )
    diskGroup: str = ""
    id: int = 0
    ...
    autoTierPolicy: str = ""
    performance: DiiAssetsVolumesReplicasourcePerformance = Field(
        default_factory=DiiAssetsVolumesReplicasourcePerformance
    )
