# ruff: noqa: N815
"""DiiAssetsQtreesVolume information."""
...
class DiiAssetsQtreesVolumeCapacity(OntapModel):
    """DiiAssetsQtreesVolumeCapacity sub-model for capacity."""
...
class DiiAssetsQtreesVolumePerformance(OntapModel):
    """DiiAssetsQtreesVolumePerformance sub-model for performance."""
...
class DiiAssetsQtreesVolume(OntapModel):
    """DiiAssetsQtreesVolume information."""
    ...
    uuid: str = ""
    capacity: DiiAssetsQtreesVolumeCapacity = Field(default_factory=DiiAssetsQtreesVolumeCapacity)
    diskGroup: str = ""
    id: int = 0
    ...
    autoTierPolicy: str = ""
    performance: DiiAssetsQtreesVolumePerformance = Field(
        default_factory=DiiAssetsQtreesVolumePerformance
    )
