# ruff: noqa: N815
"""DiiAssetsStoragenodesVolume information."""
...
class DiiAssetsStoragenodesVolumeCapacity(OntapModel):
    """DiiAssetsStoragenodesVolumeCapacity sub-model for capacity."""
...
class DiiAssetsStoragenodesVolumePerformance(OntapModel):
    """DiiAssetsStoragenodesVolumePerformance sub-model for performance."""
...
class DiiAssetsStoragenodesVolume(OntapModel):
    """DiiAssetsStoragenodesVolume information."""
    ...
    uuid: str = ""
    capacity: DiiAssetsStoragenodesVolumeCapacity = Field(
        default_factory=DiiAssetsStoragenodesVolumeCapacity
    )
    diskGroup: str = ""
    id: int = 0
    ...
    autoTierPolicy: str = ""
    performance: DiiAssetsStoragenodesVolumePerformance = Field(
        default_factory=DiiAssetsStoragenodesVolumePerformance
    )
