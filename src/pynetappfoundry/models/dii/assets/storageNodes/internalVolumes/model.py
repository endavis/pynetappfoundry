# ruff: noqa: N815
"""DiiAssetsStoragenodesInternalvolume information."""
...
class DiiAssetsStoragenodesInternalvolumeCapacity(OntapModel):
    """DiiAssetsStoragenodesInternalvolumeCapacity sub-model for capacity."""
...
class DiiAssetsStoragenodesInternalvolumePerformance(OntapModel):
    """DiiAssetsStoragenodesInternalvolumePerformance sub-model for performance."""
...
class DiiAssetsStoragenodesInternalvolume(OntapModel):
    """DiiAssetsStoragenodesInternalvolume information."""
    ...
    type_: str = ""
    uuid: str = ""
    capacity: DiiAssetsStoragenodesInternalvolumeCapacity = Field(
        default_factory=DiiAssetsStoragenodesInternalvolumeCapacity
    )
    ...
    performance: DiiAssetsStoragenodesInternalvolumePerformance = Field(
        default_factory=DiiAssetsStoragenodesInternalvolumePerformance
    )
