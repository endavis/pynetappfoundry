# ruff: noqa: N815
"""DiiAssetsDisksBackendvolume information."""
...
class DiiAssetsDisksBackendvolumeCapacity(OntapModel):
    """DiiAssetsDisksBackendvolumeCapacity sub-model for capacity."""
...
class DiiAssetsDisksBackendvolumePerformance(OntapModel):
    """DiiAssetsDisksBackendvolumePerformance sub-model for performance."""
...
class DiiAssetsDisksBackendvolume(OntapModel):
    """DiiAssetsDisksBackendvolume information."""
    ...
    uuid: str = ""
    capacity: DiiAssetsDisksBackendvolumeCapacity = Field(
        default_factory=DiiAssetsDisksBackendvolumeCapacity
    )
    diskGroup: str = ""
    id: int = 0
    ...
    autoTierPolicy: str = ""
    performance: DiiAssetsDisksBackendvolumePerformance = Field(
        default_factory=DiiAssetsDisksBackendvolumePerformance
    )
