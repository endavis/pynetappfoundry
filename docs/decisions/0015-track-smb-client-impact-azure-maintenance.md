...
- **CLUSTER-PROD-01**: `cf.transition.info` showed `CIFS=14450ms` (14.4 second disruption)
- **CLUSTER-PROD-02**: `cf.transition.info` showed `CIFS=14709ms` (14.7 second disruption)
- **CLUSTER-PROD-03**: Minimal CIFS events (no CIFS clients connected during maintenance)
